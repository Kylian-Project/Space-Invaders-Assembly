...
# Structure pour représenter un envahisseur
	env_x: .word 2   # Position en x de l'envahisseur
  	env_y: .word 2   # Position en y de l'envahisseur
...
# Structure pour représenter un missile
  	missile_x: .word 30    # Position en x du missile
  	missile_y: .word 30   # Position en y du missile
  	missile_dir: .word 0    # Direction du missile (vers le haut ou le bas)
  	missile_etat: .word 0   # État du missile (détruit ou en vol)
# Variables missiles
missile_couleur: .word 0xffffffff
missile_longueur: .word 12
missile_epaisseur: .word 3
...
E_creer:
	...
	li a0 36 # 9 paramètres pour envahisseur * 4
	li a7 9
	ecall
